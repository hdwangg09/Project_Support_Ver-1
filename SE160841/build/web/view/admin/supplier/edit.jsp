                    ...
                    <div class="card my-4">
                        ...
                        <div class="card-body px-0 pb-2">
                            <div class="form-responsive p-4 " style="margin-left: 2%;">
                                ...
                                <form class=" form align-items-center mb-4 " action="../admin/editSupplier" method="post">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="supplierName" name="supplierName" value="${supplier.tenncc}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="supplierAdress" name="supplierAdress" value="${supplier.diachi}"
