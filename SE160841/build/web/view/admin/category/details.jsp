                        ...
                        <div class="card my-4">
                            ...
                            <div class="card-body px-0 pb-2">
                                <div class="form-responsive p-4 " style="margin-left: 2%;">
                                    ...
                                    <form class=" form align-items-center mb-4 " action="../admin/editCategory?categoryID=${category.madm}" method="post">
                                        <div class="form-group row">
                                            <label for="categoryID" class="col-sm-8 col-form-label">Category ID</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="categoryID" name="categoryID"
                                                       value="${category.madm}" readonly>
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <label for="categoryName" class="col-sm-8 col-form-label">Category Name</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="categoryName" value="${category.tendm}" readonly=""
                                                       name="categoryName" placeholder="Enter Category Name">
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <label for="accountStatus" class="col-sm-8 col-form-label">Category
                                                Status</label>
                                            <div class="col-sm-4">
                                                <select class="form-control" id="categoryStatus" name="categoryStatus" readonly>
                                                    <option ${category.trangthai ? "selected = 'selected'" : ""} value="active">Active</option>
                                                    <option ${!category.trangthai ? "selected = 'selected'" : ""} value="deactive">Deactive</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row ">
