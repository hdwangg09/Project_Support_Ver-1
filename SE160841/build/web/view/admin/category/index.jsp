                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                    <h6 class="text-white text-capitalize ps-3">Category Manager </h6>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            <c:forEach items="${requestScope.listCategory}" var="category">
                                                <tr>
                                                    <td>
                                                        <div class="d-flex px-4 py-1">
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="../admin/categoryDetails?categoryID=${category.madm}"><span class="text-secondary text-xs font-weight-bold">${category.madm}</span></a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <span class="text-secondary text-xs font-weight-bold">${category.tendm}</span>
                                                    </td>
                                                    <c:if test="${category.trangthai}">
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <a href="../admin/editCategory?categoryID=${category.madm}" class="text-secondary font-weight-bold text-xs"
                                                           data-toggle="tooltip" data-original-title="Edit user">
                                                            Edit
                                                        </a>
                                                        <a href="../admin/categoryDetails?categoryID=${category.madm}" class="text-secondary font-weight-bold text-xs"
                                                           data-toggle="tooltip" data-original-title="Details user">
                                                            Details
                                                        </a>
                                                    </td>
                                                </tr>    
