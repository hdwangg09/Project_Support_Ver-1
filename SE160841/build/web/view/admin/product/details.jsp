                                    ...
                                    <form class=" form align-items-center mb-4 ">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="productDescriptions"  
                                                       name="productDescriptions" value="${product.mota}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="accountStatus" class="col-sm-8 col-form-label">
                                                Supplier</label>
                                            <div class="col-sm-4">
                                                <select class="form-control" id="productSupplier" name="productSupplier" readonly>
                                        ...
                                        <div class="form-group row">
                                            <label for="accountStatus" class="col-sm-8 col-form-label">
                                                Category</label>
                                            <div class="col-sm-4">
                                                <select class="form-control" id="productCategory" name="productCategory" readonly>
                                        ...
                                        <div class="form-group row">
                                            <label for="accountStatus" class="col-sm-8 col-form-label">
                                                Status</label>
                                            <div class="col-sm-4">
                                                <select class="form-control" id="productStatus" name="productStatus" readonly>
